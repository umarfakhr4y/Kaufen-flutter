...
class ProfilePenjual extends StatefulWidget {
  @override
  _ProfilePenjualState createState() => _ProfilePenjualState();
}

class _ProfilePenjualState extends State<ProfilePenjual> {
  DataLogin dataLogin;
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    ...
                    children: [
                      if (dataLogin.success.image.contains("img"))
                        CircleAvatar(
